...
const Navbar = () => {
  return (
    <div id="Home" className="bg-[#0b1320] text-white w-screen h-screen">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-10 px-6 md:px-20 py-10">
        ...
        <img
          className="w-100 h-100 rounded-full object-cover transform transition-transform duration-500 hover:scale-110 bg-blue-500 p-1"
          src="aniket5.jpg"
          alt="My Image"
        />
        ...
        <div className="flex flex-col gap-4 md:gap-6 text-center md:text-left">
          <h1 className="text-4xl md:text-6xl text-yellow-300 font-bold typewriter">Aniket Ghosh</h1>
